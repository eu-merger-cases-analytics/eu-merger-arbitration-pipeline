...
Output is printed to the console and saved to inspect_json_output.txt in the same folder.
...
def main() -> None:
    if not JSON_PATH.exists():
        ...
        print("    Run first: python scripts/ingestion/download_json.py")
        return
    ...
    out(f"All statistics below are for cases containing '6(1)(b)' or '8(2)' in")
